"""
Módulo de backtesting con apalancamiento.

Este módulo implementa un backtesting de estrategias con soporte para apalancamiento,
simulación de liquidaciones y gestión de funding rates para futuros perpetuos.
"""
    ...
    for liq in liquidations:
        ...
        if entry_idx is not None:
            ...
            if not trades_df.empty:
                trades_df = pd.concat([trades_df, pd.DataFrame([liq_trade])], ignore_index=True)
            else:
